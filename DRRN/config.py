...
if mode == "train":
    ...
    valid_image_dir = "data/image_data"
...
if mode == "valid":
    # Test data address
    lr_dir = f"data/image_data/lr2"
    sr_dir = f"results/test/{exp_name}"
    hr_dir = f"data/image_data/hr2"

#    model_path = f"results/drrn_B1U9-TB291-73ce58b1.pth.tar"
    model_path = f"results/DRRN_B1U9/best.pth.tar"
